      ...
      <section className="container grid items-center gap-6 py-10 pb-8">
        <div className="ml-12 flex w-full flex-col items-start gap-2">
          ...
          <Button
            ...
            asChild
          >
            <Link href="#Whitelist">Whitelist Now</Link>
          </Button>
          <div className="pt-1" />
        ...
        <section className="container absolute inset-x-0 top-[450px] grid items-center gap-6 py-10 pb-8">
          ...
          <Text>
            ...
            web2 and web3 industries. Openmesh is similar to Amazon AWS,
            Microsoft Azure, NVidia, and Google Cloud but designed for the
            future of the internet - web3. It combines the best features of AWS,
            IPFS, Chainlink, BitTorrent, and Oracle Cloud into a single solution
            that offers decentralized oracle and cloud capabilities. Our team
            brings diverse experience from prominent web2 companies and web3
            projects, including Fantom, Ripple, AWS, Oracle, Cosmos, and Aragon.
            Our team is predominantly located in Sydney and the U.S.
          </Text>
          ...
          <Text>
            ...
            healthcare systems to enhance productivity and quality of life, so
            too does the technology that powers our daily lives. . Web3 is the
            future of the internet, and it is a pivotal point where improvements
            are necessary.
          </Text>
          <Text>
            ...
            and AI capabilities. Openmesh aims to do what Airbnb and Uber did
            for the transportation and hotel industries, allowing people to
            offer their unused compute, storage, and GPUs instead of relying
            solely on large corporations like Google.
          </Text>
          <Text>
          ...
          <Text>
            We envision a world where data is open, decentralized, and
            beneficial to everyone, not just a select few. This isn&apos;t
            solely about technology but rather about shaping the next 10-20
            years of the internet, preserving democracy, and ensuring a free
            flow of information for generations to come.
          </Text>
          ...
          <Text>
            ...
            <ListItem>
              Xnode Search: A Skyscanner-style infrastructure aggregation tool
              to search and connect with public clouds, private and public data
          ...
          <Text>
            ...
            <ListItem>
              ...
              Giveaway marketing campaign (“Decentralized Cloud Initiative
              2024”), where we are committing $100 million worth of cloud
              credits to support the web3 startup ecosystem. This is the largest
              commitment by any decentralized cloud project in web3 to date.
            </ListItem>
            <ListItem>
            ...
            <ListItem>
              September: Openmesh Cloud launch with 90% lower cost than any
              cloud provider
            </ListItem>
            <ListItem>
            ...
            <ListItem>
              November: OpenD/I 2024 Conference & Hackathon sponsored by
              Openmesh and held in New York City
            </ListItem>
          </Text>
          ...
          <Text>
            ...
            <ListItem>
              Funds will be used for Openmesh operational expenses and to
              support strategic expansions planned through 2024.
            </ListItem>
          </Text>
          ...
          <Text>
            ...
            <ListItem>
              Location: Sydney and remote participation options
            </ListItem>
            <ListItem>
          ...
          <Text>
            <ListItem>
              Invoice & Payment: After the event, sponsors will receive an
              invoice and choose their preferred payment method. The payment
              should be completed during this phase to confirm participation in
              the program.
            </ListItem>
          </Text>
          <Subtitle>
          ...
          <Text>
            ...
            <ListItem>
              ...
              governance tokens as an appreciation for their support. These
              tokens will allow sponsors to contribute to the network&apos;s
              governance, particularly in becoming an Openmesh Verified Resource
              Provider.
            </ListItem>
          </Text>
          ...
          <Text>
            ...
            concerns, particularly for sponsors based in Australia. A
            specialized tax law firm in Sydney will manage all necessary
            reporting and filings, ensuring compliance without requiring the
            establishment of a formal company, given Openmesh is structured as a
            Decentralized Autonomous Organization (DAO). (DAO structures are
            very common practice in the Web3 industry)
          </Text>
          ...
          <Text>
            ...
            <ListItem>
              Receive Cloud Credits & Tokens: After participation, mint your
              Cloud Credits and, if desired, claim governance tokens.
            </ListItem>
            <ListItem>
              Stay Engaged: Contribute to the Openmesh community and stay
